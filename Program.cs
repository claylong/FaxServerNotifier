...
namespace Fax_Server_Notifier
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //MessageBox.Show(string.Join(", ", System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceNames()));
            FaxServerSystray notifier = FaxServerSystray.GetNotifierObject();
            Application.Run();
            notifier = null; //must be done to stop referencing notifier so GC can collect it.
        }
